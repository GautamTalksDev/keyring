...
export const createScanBodySchema = z
  ...
  .refine(
    ...
    {
      message:
        "person or scope is required (replay needs recordingId or person; reaudit may omit)",
    },
  );

export type CreateScanBody = z.infer<typeof createScanBodySchema>;

export const cardDecisionBodySchema = z.object({
...
export const executeScanBodySchema = z.object({
